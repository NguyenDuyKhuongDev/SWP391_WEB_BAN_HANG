...
namespace OnlineShop.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Slug,CreateAt")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Slug,CreateAt")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
